...
export default function ActivityFeed({ userId }: ActivityFeedProps) {
 ...
 : 'bg-[rgba(184,115,51,0.08)] text-[#7A6B58] hover:bg-[rgba(184,115,51,0.12)] '
 }`}
 >
 {option.label}
 </button>
 ...
 <p className="text-[#7A6B58]">Aktivite akışı yükleniyor...</p>
 </div>
 )}
 ...
 <p className="text-[#7A6B58] text-lg">Aktivite yok</p>
 ...
 className="block p-4 bg-[var(--bg-card)] rounded-sm border border-[rgba(184,115,51,0.14)] hover:shadow-md hover:border-blue-300 transition-all"
 >
 ...
 <div className="w-12 h-12 rounded-full bg-gradient-to-br from-urfa-500 to-isot-700 flex items-center justify-center text-white font-bold text-sm">
 ...
 <span className="px-2 py-0.5 text-xs font-bold rounded bg-[rgba(168,85,247,0.1)] text-purple-300 ">
 Lv{activity.user_level}
 </span>
 )}
 </div>
 </div>
 <p className="text-xs text-[#7A6B58] flex-shrink-0">
 {formatTime(activity.created_at)}
 </p>
 </div>

 {/* Activity Description */}
 <p className="text-[#4A3828] mb-2">
 ...
 className="px-6 py-2 bg-urfa-600 text-white rounded-sm hover:bg-urfa-700 transition-colors font-medium"
 >
 Daha Fazla Yükle
 </button>
 </div>

          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                className="rounded border border-emerald-400 px-2 py-1 text-[10px] text-emerald-700"
                onClick={() => {
                  const key = window.prompt('İlçe anahtarı:')?.trim();
                  const hours = Number(window.prompt('Hedef saat:', '48') || 48);
                  if (key) upsertSlaBucket('byDistrict', key, hours);
                }}
              >
                + Ekle
              </button>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                className="rounded border border-emerald-400 px-2 py-1 text-[10px] text-emerald-700"
                onClick={() => {
                  const key = window.prompt('Team key:')?.trim();
                  const hours = Number(window.prompt('Target hour:', '48') || 48);
                  if (key) upsertSlaBucket('byTeam', key, hours);
                }}
              >
                + Ekle
              </button>

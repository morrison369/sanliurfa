...
export default function PharmacyManager() {
 ...
 {loading ? (
 <div className="text-center py-8 text-[#4A3828]">Yükleniyor…</div>
 ...
 onClick={saveDuty}
 disabled={saving}
 className="px-6 py-2.5 bg-green-600 text-white font-medium rounded-sm hover:bg-green-700 disabled:opacity-50"
 >
 ...
 {allPharmacies.length === 0 && (
 <tr><td colSpan={4} className="text-center py-8 text-[#4A3828]">Eczane bulunamadı</td></tr>
 )}
 </tbody>
 </table>
 </div>

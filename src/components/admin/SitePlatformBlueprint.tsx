...
export default function SitePlatformBlueprint() {
  ...
  if (status === 'loading') {
    return (
      <section className="mb-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <p className="text-sm text-slate-600">DB-first platform yönetimi yükleniyor...</p>
      </section>
    );
  }
  ...
  if (status === 'error') {
    return (
      <section className="mb-6 rounded-3xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
        <h2 className="text-lg font-bold text-amber-900">DB-first platform yönetimi alınamadı</h2>
    ...
    <section className="mb-6 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          <h3 className="text-lg font-bold text-slate-900">Homepage Section Formu</h3>
          <FormText
            label="Section Key"
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          <h3 className="text-lg font-bold text-slate-900">Şehir Servisi Formu</h3>
          <FormText
            label="Service Key"
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          <h3 className="text-lg font-bold text-slate-900">SEO Override Formu</h3>
          <FormText
            label="Entity Type"
...
function JsonArea({
  ...
  return (
    <label className="mt-3 block">
      ...
      <textarea
        className="min-h-[120px] w-full rounded-xl border border-slate-300 bg-white px-3 py-2 font-mono text-xs text-slate-900"
        value={value}
        onChange={(e) => onChange(e.target.value)}
      />
    </label>

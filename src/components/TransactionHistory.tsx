...
export function TransactionHistory() {
 ...
 className={`px-3 py-1 rounded-sm text-sm font-medium transition capitalize ${
 selectedType === type
 ? 'bg-urfa-600 text-white'
 : 'bg-[rgba(184,115,51,0.1)] text-[#7A6B58] hover:bg-[rgba(184,115,51,0.18)]'
 }`}
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="bg-[rgba(184,115,51,0.08)] rounded-sm h-16 animate-pulse"></div>
 ))}
 </div>
 ...
 <div
 key={tx.id}
 className={`bg-[var(--bg-card)] border rounded-sm p-4 ${tx.is_expired ? 'opacity-60' : ''}`}
 >
 ...
 className="px-4 py-2 bg-[rgba(184,115,51,0.2)] text-white rounded-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[var(--bg-card)]"
 >
 Önceki
 </button>

...
export default function OLAPExplorer() {
 ...
 <div className="space-y-2 p-4 border rounded bg-[rgba(184,115,51,0.04)]">
 {dimensions.map(dim => (
 ...
 disabled={loading}
 className="px-6 py-2 bg-urfa-600 text-white rounded hover:bg-urfa-700 disabled:opacity-50"
 >
 {loading ? 'Querying...' : 'Execute Query'}
 </button>
 </div>

 {cached && <div className="text-xs text-[#7A6B58]">✓ Result from cache</div>}
 ...
 <thead>
 <tr className="bg-[rgba(184,115,51,0.06)] border-b">
 ...
 <tbody>
 {results.map((row, idx) => (
 <tr key={idx} className="border-b hover:bg-[rgba(184,115,51,0.04)]">
 {selectedDimensions.map(d => (

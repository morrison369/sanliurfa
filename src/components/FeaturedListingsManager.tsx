...
export default function FeaturedListingsManager({ onListingCreated }: FeaturedListingsManagerProps) {
 ...
 <h2 className="text-2xl font-bold text-[#1F1410]">Öne Çıkan Listeler</h2>
 <button
 ...
 className="px-4 py-2 bg-[rgba(184,115,51,0.12)] text-[#7A6B58] rounded-sm hover:bg-[rgba(184,115,51,0.2)] transition-colors"
 >
 İptal Et
 </button>
 </div>
 ...
 <h3 className="text-lg font-semibold text-[#1F1410]">{listing.title}</h3>
 ...
 <span className="px-2 py-1 bg-[rgba(59,130,246,0.1)] text-blue-300 rounded capitalize">
 ...
 <Eye size={16} className="text-[#4A3828]" />
 <span>{listing.views_count} görüntülenme</span>
 </div>
 <div className="flex items-center gap-2">
 <TrendingUp size={16} className="text-[#4A3828]" />

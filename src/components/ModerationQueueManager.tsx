...
export default function ModerationQueueManager() {
 ...
 className="px-3 py-1 bg-urfa-600 text-white text-sm rounded-sm hover:bg-urfa-700 disabled:opacity-50 flex items-center gap-1"
 >
 ...
 disabled={actionInProgress === item.id}
 className="px-3 py-1 bg-green-600 text-white text-sm rounded-sm hover:bg-green-700 disabled:opacity-50 flex items-center gap-1"
 >
 {actionInProgress === item.id ? (
 <Loader className="w-4 h-4 animate-spin" />
 ) : (

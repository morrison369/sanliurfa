...
export function extractUserSettingsProfile(
  payload: unknown,
  ...
  return {
    ...
    language_preference:
      typeof profile.language_preference === 'string'
        ? profile.language_preference
        : 'tr',
    theme_preference:
      typeof profile.theme_preference === 'string'
...
export function extractUserSettingsMessage(
  payload: unknown,
  fallback: string,
): string {
  const data = resolveEnvelopeData(payload);

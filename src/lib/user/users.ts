 ...
 * NOT: Dil tercihi (language_preference) güncellenemez. Site SADECE Türkçe destekler.
 * @see AGENTS.md - Yasaklar bölümü
 */
export async function updateUserSettings(
  userId: string,
  updates: {
    // language_preference KALDIRILDI - Sadece Türkçe desteklenir
    theme_preference?: string;
    notification_preferences?: {
      email?: boolean;
      push?: boolean;
  ...
  try {
    ...
    // Dil tercihi güncellemesi ENGELLENDİ - Sadece Türkçe desteklenir

...
export function normalizeSubscriptionAdminTab(
...
export function extractSubscriptionAdminAnalytics(
  ...
  if (
    ...
    'subscriptions' in directData &&
    'webhooks' in directData
  ) {
  ...
  const nestedData =
    directData && typeof directData === 'object'
      ? (directData as { data?: unknown }).data
      : null;
  if (
    nestedData &&
    typeof nestedData === 'object' &&
    'subscriptions' in nestedData &&
    'webhooks' in nestedData
  ) {

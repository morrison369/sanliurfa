...
export async function getPromotion(promotionId: string): Promise<Promotion | null> {
  try {
    ...
    logger.error('Failed to get promotion', error instanceof Error ? error : new Error(String(error)) as any);
    return null;
  }
}
...
export async function getPlacePromotions(placeId: string): Promise<Promotion[]> {
  try {
    ...
    logger.error('Failed to get place promotions', error instanceof Error ? error : new Error(String(error)) as any);
    return [];
  }
}
...
export async function validatePromotion(
  ...
  try {
    ...
    logger.error('Failed to validate promotion', error instanceof Error ? error : new Error(String(error)) as any);
    return {
      valid: false,
...
export async function searchPromotions(query: string, limit: number = 20): Promise<Promotion[]> {
  try {
    ...
    logger.error('Failed to search promotions', error instanceof Error ? error : new Error(String(error)) as any);
    return [];
  }
}
...
export async function redeemPromotion(promotionId: string, userId: string, discountAmount: number): Promise<boolean> {
  try {
    ...
    logger.error('Failed to redeem promotion', error instanceof Error ? error : new Error(String(error)) as any);
    return false;
  }
}
...
export async function getPromotionStats(placeId: string): Promise<PromotionStats> {
  try {
    ...
    logger.error('Failed to get promotion stats', error instanceof Error ? error : new Error(String(error)) as any);
    return {
      totalRedemptions: 0,
...
export async function getTrendingPromotions(limit: number = 10): Promise<Promotion[]> {
  try {
    ...
    logger.error('Failed to get trending promotions', error instanceof Error ? error : new Error(String(error)) as any);
    return [];
  }
}

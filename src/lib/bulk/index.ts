...
export async function bulkDelete(
  ...
  for (const id of entityIds) {
    try {
      ...
      results.failed++;
      results.errors.push({ entityId: id, error: safeErrorDetail(error, 'Silme işlemi başarısız') });
    }
  }
...
export async function bulkUpdate(
  ...
  for (const id of entityIds) {
    try {
      ...
      results.failed++;
      results.errors.push({ entityId: id, error: safeErrorDetail(error, 'Güncelleme işlemi başarısız') });
    }
  }
...
export async function bulkModerate(
  ...
  for (const id of entityIds) {
    try {
      ...
      results.failed++;
      results.errors.push({ entityId: id, error: safeErrorDetail(error, 'Moderasyon işlemi başarısız') });
    }
  }

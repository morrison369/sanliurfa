...
export async function getReports(
  ...
  try {
    ...
    const result = await queryMany(query_str, params) as any[];
    ...
    logger.error('Failed to get reports', error instanceof Error ? error : new Error(String(error)), {} as any);
    throw error;
  }
}
...
export async function getModerationQueue(
  ...
  try {
    ...
    logger.error('Failed to get moderation queue', error instanceof Error ? error : new Error(String(error)), {} as any);
    throw error;
  }
}

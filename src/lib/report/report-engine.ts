...
/**
 * Excel format generator (CSV with .xlsx extension for compatibility)
 * Note: Uses CSV format internally for security (avoids xlsx vulnerabilities)
 */
function toExcel(headers: string[], rows: any[][]): Buffer {

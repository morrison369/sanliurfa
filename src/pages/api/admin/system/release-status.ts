...
export const GET: APIRoute = async ({ locals }) => {
  ...
  return apiResponse({
    ...
    prodEvidence: await readJson('docs/prod-evidence.json'),
    backupRestoreEvidence: await readJson('docs/backup-restore-evidence.json'),
    runtimeProdDoctor: await readJson('docs/runtime-prod-doctor.json'),

...
const coverageRules = [
  ...
  [/^\/admin\/reports\/(schedule|social-lifecycle)$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/revenue$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/reviews\/antispam-events$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/security\/(audit|guidelines)$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/social(\/|$)/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/subscriptions\/(analytics|users)$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/users(\/|$)/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/vendor(\/|$)/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/admin\/verifications(\/|$)/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/ai\/(recommendations|similar)$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/analytics$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/analytics\/(cohorts|dashboard)$/, 'openapi-p2-admin-social-analytics-contract.test.ts'],
  [/^\/analytics\/(events|funnels|journeys|performance|predictions)$/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/audit\/log$/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/badges(\/|$)/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/billing\/(checkout|webhook)$/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/blocking(\/|$)/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/blog(\/|$)/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/business-metrics$/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/business\/(analytics|insights)$/, 'openapi-p2-analytics-blog-business-contract.test.ts'],
  [/^\/business\/trends$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/cache\/stats$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/collab\/sessions$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/comments(\/|$)/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/contact(\/|$)/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/content(\/|$)/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/coupons\/validate$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/dashboards(\/|$)/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/discovery\/(recommendations|similar|trending)$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/docs$/, 'openapi-p2-business-content-email-contract.test.ts'],
  [/^\/email(\/|$)/, 'openapi-p2-business-content-email-contract.test.ts'],

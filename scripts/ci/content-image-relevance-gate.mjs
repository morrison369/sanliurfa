...
const resolverExpectations = [
  ...
  ['src/components/recipes/RelatedRecipes.astro', 'resolveRecipeImage'],
  ['src/components/SearchResults.tsx', 'resolvePlaceImage'],
  ...
  ['src/components/blog/BlogRelatedPlaces.astro', 'resolvePlaceImage'],
  ['src/components/blog/BlogRelatedEvents.astro', 'resolveEventImage'],
  ['src/components/landing/RankedPlaceCard.astro', 'resolvePlaceImage'],
...
const noInlineImageFallbackFiles = [
  ...
  'src/components/landing/RankedPlaceCard.astro',
  'src/components/food/FeaturedFoods.astro',
  'src/components/recipes/RelatedRecipes.astro',
  'src/components/blog/RelatedPosts.astro',
  'src/components/blog/BlogRelatedPlaces.astro',
  'src/components/blog/BlogRelatedEvents.astro',

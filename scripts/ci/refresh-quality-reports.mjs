...
const reportSteps = [
  ...
  run('pagespeed api research', 'node scripts/ci/pagespeed-api-research-report.mjs'),
  run('pagespeed api-less lighthouse', 'node scripts/ci/pagespeed-api-less-lighthouse-report.mjs --max-urls=1 --strategy=mobile'),
  run('pagespeed live check', 'node scripts/ci/pagespeed-live-check.mjs --max-urls=1 --strategy=mobile'),
  run('pagespeed quota management', 'node scripts/ci/pagespeed-quota-management-report.mjs'),

...
const LOCAL_TUNNEL_PORT = 15722;
const sleep = ms => new Promise(r => setTimeout(r, ms));

const SITES = [
  { slug: 'sumatar-harabesi',        query: 'ancient pagan temple ruins stone mesopotamia archaeological site rock carved' },
  { slug: 'urfa-huseyin-pasa-hammami', query: 'ottoman hammam turkish bath stone dome historic traditional architecture' },
  { slug: 'tek-tek-daglar-milli-parki', query: 'rocky mountain national park landscape ancient ruins turkey nature valley' },
  { slug: 'birecik-kalesi-surlar',   query: 'ancient fortress castle walls ruins stone river euphrates historical' },
  { slug: 'urfa-bedesteni',          query: 'historic covered bazaar market stone arch ottoman traditional crafts' },
];
...
async function main() {
  ...
  console.log('\n🏛️  Tarihi Yer Batch 5 Görselleri (Pexels)...\n');
  ...
  const tmpDir = path.join(projectRoot, 'dist', '_hist5_img_tmp');

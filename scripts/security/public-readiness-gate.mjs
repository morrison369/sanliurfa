...
const historySecretProbe = runAllowFail('git', [
  ...
  '--oneline',
  '-G',
  'CHANGE_ME_DB_PASSWORD|CHANGE_ME_DB_PASSWORD|Urfa_2024_Secure|CHANGE_ME_CWP_SSH_PASSWORD|CHANGE_ME_CWP_SSH_PASSWORD|STRIPE_SECRET_KEY_PLACEHOLDER[A-Za-z0-9]{10,}|STRIPE_WEBHOOK_SECRET_PLACEHOLDER[A-Za-z0-9]{10,}',
]);

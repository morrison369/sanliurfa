...
const LOCAL_TUNNEL_PORT = 15720;
const sleep = ms => new Promise(r => setTimeout(r, ms));

const RECIPES = [
  { slug: 'urfa-meftune',           query: 'lamb vegetable stew clay pot turkish casserole eggplant pepper' },
  { slug: 'harran-tarhana-corbasi', query: 'tarhana fermented wheat soup bowl turkish warm traditional bread' },
  { slug: 'urfa-patlican-kebabi',   query: 'stuffed eggplant kebab grilled Turkish meat pepper tomato oven' },
  { slug: 'urfa-incir-tatlisi',     query: 'dried fig walnut pistachio sweet dessert turkish plate syrup' },
  { slug: 'kalyos',                 query: 'lamb head trotter soup bowl turkish traditional morning garlic broth' },
  { slug: 'urfa-kisir',             query: 'bulgur salad spicy mezze turkish plate parsley tomato lemon' },
  { slug: 'urfa-seftali-hosafi',    query: 'peach compote dried fruit turkish dessert bowl sweet glass syrup' },
  { slug: 'pekmezli-kofte',         query: 'meatball grape molasses sauce turkish plate walnut traditional' },
  { slug: 'urfa-mercimek-corbasi',  query: 'red lentil soup turkish bowl spicy butter paprika cumin garnish' },
];
...
async function main() {
  ...
  console.log('\n🍽️  Tarif Batch 13 Görselleri (Pexels)...\n');
  ...
  const tmpDir = path.join(projectRoot, 'dist', '_batch13_recipe_img_tmp');

...
const LOCAL_TUNNEL_PORT = 15698;
const sleep = ms => new Promise(r => setTimeout(r, ms));

const RECIPES = [
  { slug: 'urfa-icli-kofte',      query: 'stuffed meatball bulgur turkish food traditional fried' },
  { slug: 'anali-kizli',          query: 'chickpea lamb stew turkish soup traditional bowl food' },
  { slug: 'urfa-eksili-kofte',    query: 'bulgur meatball lemon herb cold salad mezze turkish' },
  { slug: 'harran-sutlu-borek',   query: 'turkish borek pastry filo cheese milk baked golden' },
  { slug: 'urfa-tirit',           query: 'bread stew lamb broth turkish traditional comfort food bowl' },
  { slug: 'bostana',              query: 'watermelon cheese turkish mezze fresh summer plate' },
  { slug: 'urfa-oklava-boregi',   query: 'thin rolled pastry borek cheese filling turkish baked' },
  { slug: 'urfa-fistikli-baklava', query: 'pistachio baklava turkish sweet dessert golden syrup' },
  { slug: 'urfa-kuru-kofte',      query: 'dry meatball turkish grilled kofta plate spicy traditional' },
];
...
async function main() {
  ...
  console.log('\n🍽️  Tarif Batch 11 Görselleri (Pexels)...\n');
  ...
  const tmpDir = path.join(projectRoot, 'dist', '_batch11_recipe_img_tmp');

...
run('pkill -9 node 2>/dev/null; pm2 kill 2>/dev/null; fuser -k 6000/tcp 2>/dev/null; fuser -k 4321/tcp 2>/dev/null; sleep 2; echo KILLED', 3)
...
h = run('curl -sf http://127.0.0.1:6000/api/health || echo FAIL', 3)

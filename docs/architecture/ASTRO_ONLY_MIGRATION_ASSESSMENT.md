...
- `src/**/*.astro`: `173`
- `src/**/*.tsx`: `81`
- `.astro` dosyalarında `client:*` hydration kullanımı: `21`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 5 medium / 16 high`)

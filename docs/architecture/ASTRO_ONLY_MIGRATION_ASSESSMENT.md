...
- `src/**/*.astro`: `189`
- `src/**/*.tsx`: `63`
- `.astro` dosyalarında `client:*` hydration kullanımı: `5`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 0 medium / 5 high`)
- high-risk feasibility report: `docs/reports/astro-high-risk-feasibility.md` (`0 first / 0 later / 4 last`)
...
- son dalga adayları: `MessagingInbox`, `WebhookManager`, `ActivityFeed`, `ModerationDashboard`

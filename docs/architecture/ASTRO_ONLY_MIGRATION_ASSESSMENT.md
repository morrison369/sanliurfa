...
- `src/**/*.astro`: `176`
- `src/**/*.tsx`: `78`
- `.astro` dosyalarında `client:*` hydration kullanımı: `18`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 2 medium / 16 high`)

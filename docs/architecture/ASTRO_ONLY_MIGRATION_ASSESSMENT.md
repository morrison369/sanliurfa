...
- `src/**/*.astro`: `170`
- `src/**/*.tsx`: `85`
- `.astro` dosyalarında `client:*` hydration kullanımı: `25`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 9 medium / 16 high`)

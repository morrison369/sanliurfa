...
- `src/**/*.astro`: `144`
- `src/**/*.tsx`: `113`
- `.astro` dosyalarında `client:*` hydration kullanımı: `49`
...
- İlk migration dalgalarında `NotificationBadge`, `QuotaUsageDisplay`, `TrendingPlaces` ve `LeaderboardsDisplay` React island olmaktan çıkarıldı.

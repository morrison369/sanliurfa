...
- `src/**/*.astro`: `167`
- `src/**/*.tsx`: `88`
- `.astro` dosyalarında `client:*` hydration kullanımı: `29`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 13 medium / 16 high`)

...
- `src/**/*.astro`: `162`
- `src/**/*.tsx`: `93`
- `.astro` dosyalarında `client:*` hydration kullanımı: `34`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 18 medium / 16 high`)

...
- `src/**/*.astro`: `166`
- `src/**/*.tsx`: `89`
- `.astro` dosyalarında `client:*` hydration kullanımı: `30`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 14 medium / 16 high`)

...
- `src/**/*.astro`: `175`
- `src/**/*.tsx`: `79`
- `.astro` dosyalarında `client:*` hydration kullanımı: `19`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 3 medium / 16 high`)

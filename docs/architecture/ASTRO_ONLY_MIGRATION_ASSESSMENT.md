...
- `src/**/*.astro`: `165`
- `src/**/*.tsx`: `90`
- `.astro` dosyalarında `client:*` hydration kullanımı: `31`
- `astro.config.mjs` içinde aktif React entegrasyonu: `@astrojs/react`
- generated inventory: `docs/reports/astro-hydration-inventory.md` (`0 low / 15 medium / 16 high`)

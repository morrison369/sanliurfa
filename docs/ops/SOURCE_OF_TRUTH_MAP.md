...
| Admin index risk/tool view modeli | `src/lib/admin-index.ts`, `src/lib/admin-index-page.ts` | `src/lib/__tests__/admin-index.test.ts`, `src/lib/__tests__/admin-index-page.test.ts` | `src/pages/admin/index.astro` |

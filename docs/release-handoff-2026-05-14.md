...
- Script surface: `368 script / 64 family / 0 top-level`
...
- PageSpeed API-less Lighthouse: `review` (api no, perf 0.98, a11y n/a, best 0.77, seo 1)
...
- `docs/e2e-report.md`
- `docs/release-handoff-2026-05-14.md`
...
3. Script canonical surface: 15 canonical command, 0 missing, 368 total package scripts.
...
6. Release next actions: 7 aksiyon, 1 kanıt/gözlem bekleyen madde.
7. Release artifact freshness: passed; stale/missing=0, max age=180 minutes.
8. Release handoff summary: Generated at 2026-05-14T20:08:07.065Z; status=ready_with_advisories, local-storage=ok, pagespeed-api-less=review.
...
17. DB retirement observation: P0 quarantine=2, runtime hold=1, P1=0, P2=766. Otomatik drop yok; en erken aksiyon 2026-05-28T20:46:04.084Z.
18. DB P0 quarantine plan: 2 quarantine candidate, 1 runtime hold. Automatic drop/quarantine yok.
19. DB observation cadence: 2/14 snapshot, 12 eksik gün, status=observing.
20. DB observation calendar: 2/14 observation day complete; next snapshot=2026-05-15T20:07:34.972Z, earliest action=2026-05-28T20:07:34.972Z, auto drop yok.
...
23. DB prod/current version compare: DATABASE_URL localhost/sanliurfa: 188/188 source migration matched, 0 pending/unmatched, 4 DB-only.
24. DB index review plan: 766 reviewable index candidate, 505 high-risk keep/review. Automatic index drop disabled.
25. DB advisory evidence bundle: 2 quarantine candidate, 1 runtime hold, observation 2/14. Automatic DB/index drop disabled.
26. Zero-result search report: 0 unresolved query / 0 occurrence.
27. Local upload parity: 928 upload dosyası, 0 missing ref, 0 unreferenced candidate.
28. Local upload bucket quota: 5 bucket, 0 blocker, 0 review, 0 advisory.
29. Local upload candidate classification: 0 candidate: 0 observed, 0 archive candidate, 0 delete-review. Otomatik silme yok.
30. Local upload archive candidates: 0 manual archive PR candidate, 0 delete-review. Otomatik silme yok.
31. Local media storage gate: local-only=yes, external-object-storage=no, live checks=5/5, failed patterns=0.
32. Static image integrity gate: 200 local public image checked; failed=0, review=0. CDN/object-storage varsayımı yok.
33. Media readiness: 5/5 media checks passed; uploads=928, public-images=200, local-storage-only=yes.
34. Admin strict role gate: 32/32 high-impact admin endpoint strict role checks passed; review=0.
35. Unit skip report: 0 skipped test file, 0 skipped test, 0 undocumented skip declaration.
36. Redis runtime health: idle; 127.0.0.1:6381 ping=fail. Fallback release blocker değil.
37. Warmup safety: ok; warmup yeni port/dev server açmamalı ve sadece mevcut base URL fetch etmelidir.
38. Cron readiness: 16/16 managed cron job preview içinde mevcut.
39. LLMS/Sitemap auto update: 6/6 auto-update check geçti. llms.txt, llms-full.txt, sitemap index, section sitemap, dynamic sitemap ve robots discovery izleniyor.
40. Blog rich results: 40/40 blog draft rich results/schema parity check geçti; review=0.
41. Blog draft quality: 40/40 blog draft content quality/source safety check gecti; review=0.
42. Blog publish readiness: 40 blog draft prod ortamda published/existing; issues=0, autoPublish=false.
43. Blog admin publish queue: 40 blog draft admin review kuyrugunda; quality=40, rich=40, autoPublish=false.
44. Publish all content drafts: 0 draft-like content remains; city_content_drafts updated=447, moderation auto-approved=no.
45. PageSpeed API research: PageSpeed API service enabled=yes, local-storage policy=documented.
46. PageSpeed API-less Lighthouse: 0/1 Lighthouse CLI check ok; API used=no, status=review, perf=0.98, best=0.77, seo=1.
47. PageSpeed live check: 0/0 live checks ok; quota-limited=1.
48. PageSpeed quota management: Quota management marked=yes, completed=yes, live status=review, quota-limited=1.
49. Backend/frontend improvements: 14/14 improvement checks passed; backend=9/9, frontend=5/5.

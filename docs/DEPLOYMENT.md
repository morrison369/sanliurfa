...
> ⚠️ **Bu doküman GEÇERSİZ — proje Kubernetes ile deploy edilmiyor.** Gerçek
> production deployment **CWP (CentOS Web Panel) shared hosting + PM2** ile
> yapılır. Canonical doküman: **proje kökündeki [DEPLOYMENT.md](../DEPLOYMENT.md)**.
>
> Aşağıdaki Kubernetes/Helm talimatları farklı bir senaryo için yazılmış,
> mevcut deployment ile alakası yok. Sadece ileride container orkestrasyonuna
> geçilirse referans olur — şu anda **uygulamayın**.
